...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine();
            HelpMarker("Required back-end to feed in gamepad inputs in "
            ...
            ImGui::SameLine();
            HelpMarker("Instruct back-end to not alter mouse cursor shape and "
                       "visibility.");
        ...
        {
            HelpMarker("Those flags are set by the back-ends (imgui_impl_xxx "
                       "files) to specify their capabilities.\n"
                       "Here we expose then as read-only fields to avoid "
                       "breaking interactions with your back-end.");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Selectables"))
    {
        ...
        if (ImGui::TreeNode("Grid"))
        {
            ...
            {
                ImGui::PushID(i);
                if (ImGui::Selectable("Sailor", selected[i] != 0, 0,
                                      ImVec2(50, 50)))
                {
                    // Toggle
...
// natural type maximum, hence the /2.
        ...
        ImGui::SameLine();
        HelpMarker("You can use the 'power' parameter to increase tweaking "
    ...
    if (ImGui::TreeNode("Drag and Drop"))
    {
        ...
        if (ImGui::TreeNode("Drag and drop to copy/swap items"))
        {
            ...
            const char* names[9] = { "Bobby",   "Beatrice", "Betty",
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        ImGui::SameLine();
        HelpMarker("We expose this for testing because scrolling sometimes had "
                   "issues with window decoration such as menu-bars.");
        ...
        HelpMarker("Use SetScrollHereX() or SetScrollFromPosX() to scroll to a "
                   ...
                   "scrolling to the top/bottom/left/right-most item will add "
                   "an additional WindowPadding to reflect "
    ...
    if (ImGui::TreeNode("Clipping"))
    {
        ...
        ImGui::TextWrapped("On a per-widget basis we are occasionally clipping "
                           ...
                           "Otherwise we are doing coarser clipping + passing "
                           "a scissor rectangle to the renderer. "
...
static void ShowDemoWindowColumns()
{
    ...
    ImGui::SameLine();
    HelpMarker("Disable the indenting of tree nodes so demo columns can use "
        ...
        if (ImGui::BeginTabItem("Colors"))
        {
            ...
            for (int i = 0; i < ImGuiCol_COUNT; i++)
            {
                    ...
                    0)
                {
                    ...
                    // docs/FONTS.txt about using icon fonts. It's really easy
